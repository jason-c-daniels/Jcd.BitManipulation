...
public class BigEndianReadBytesBenchmarks
{
   ...
   [Benchmark]
   public byte[] BigEndianByteIndexer_Slice_Double_New_Inst()
   {
      return ((BigEndianByteIndexer) Dbl).Slice(0, sizeof(double));
   }

   [Benchmark]
   public byte[] BigEndianByteIndexer_Slice_Float_New_Inst()
   {
      return ((BigEndianByteIndexer) Flt).Slice(0, sizeof(float));
   }

   [Benchmark]
   public byte[] BigEndianByteIndexer_Slice_UInt64_New_Inst()
   {
      return ((BigEndianByteIndexer) Ui64).Slice(0, sizeof(ulong));
   }

   [Benchmark]
   public byte[] BigEndianByteIndexer_Slice_Int64_New_Inst()
   {
      return ((BigEndianByteIndexer) I64).Slice(0, sizeof(long));
   }

   [Benchmark]
   public byte[] BigEndianByteIndexer_Slice_UInt32_New_Inst()
   {
      return ((BigEndianByteIndexer) Ui32).Slice(0, sizeof(uint));
   }

   [Benchmark]
   public byte[] BigEndianByteIndexer_Slice_Int32_New_Inst()
   {
      return ((BigEndianByteIndexer) I32).Slice(0, sizeof(int));
   }

   [Benchmark]
   public byte[] BigEndianByteIndexer_Slice_UInt16_New_Inst()
   {
      return ((BigEndianByteIndexer) Ui16).Slice(0, sizeof(ushort));
   }

   [Benchmark]
   public byte[] BigEndianByteIndexer_Slice_Int16_New_Inst()
   {
   ...
   [Benchmark]
   public byte[] BigEndianByteIndexerFloat_Slice()
   {
      return BeFlt.Slice(0, sizeof(float));
   }

   [Benchmark]
   public byte[] BigEndianByteIndexerDouble_Slice()
   {
      return BeDbl.Slice(0, sizeof(double));
   }

   [Benchmark]
   public byte[] BigEndianByteIndexerUInt64_Slice()
   {
      return Beui64.Slice(0, sizeof(ulong));
   }

   [Benchmark]
   public byte[] BigEndianByteIndexerInt64_Slice()
   {
      return Bei64.Slice(0, sizeof(long));
   }

   [Benchmark]
   public byte[] BigEndianByteIndexerUInt32_Slice()
   {
      return Beui32.Slice(0, sizeof(uint));
   }

   [Benchmark]
   public byte[] BigEndianByteIndexerInt32_Slice()
   {
      return Bei32.Slice(0, sizeof(int));
   }

   [Benchmark]
   public byte[] BigEndianByteIndexerUInt16_Slice()
   {
      return Beui16.Slice(0, sizeof(ushort));
   }

   [Benchmark]
   public byte[] BigEndianByteIndexerInt16_Slice()
   {
      return Bei16.Slice(0, sizeof(short));
   }
   ...
   [Benchmark]
   public byte[] BigEndianByteIndexerDouble_Slice_New_Inst()
   {
      return ((BigEndianByteIndexerDouble) Dbl).Slice(0, sizeof(double));
   }

   [Benchmark]
   public byte[] BigEndianByteIndexerFloat_Slice_New_Inst()
   {
      return ((BigEndianByteIndexerSingle) Flt).Slice(0, sizeof(float));
   }

   [Benchmark]
   public byte[] BigEndianByteIndexerUInt64_Slice_New_Inst()
   {
      return ((BigEndianByteIndexerUInt64) Ui64).Slice(0, sizeof(ulong));
   }

   [Benchmark]
   public byte[] BigEndianByteIndexerInt64_Slice_New_Inst()
   {
      return ((BigEndianByteIndexerInt64) I64).Slice(0, sizeof(long));
   }

   [Benchmark]
   public byte[] BigEndianByteIndexerUInt32_Slice_New_Inst()
   {
      return ((BigEndianByteIndexerUInt32) Ui32).Slice(0, sizeof(uint));
   }

   [Benchmark]
   public byte[] BigEndianByteIndexerInt32_Slice_New_Inst()
   {
      return ((BigEndianByteIndexerInt32) I32).Slice(0, sizeof(int));
   }

   [Benchmark]
   public byte[] BigEndianByteIndexerUInt16_Slice_New_Inst()
   {
      return ((BigEndianByteIndexerUInt16) Ui16).Slice(0, sizeof(ushort));
   }

   [Benchmark]
   public byte[] BigEndianByteIndexerInt16_Slice_New_Inst()
   {
      return ((BigEndianByteIndexerInt16) I16).Slice(0, sizeof(short));
   }
