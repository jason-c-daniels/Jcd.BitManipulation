...
public class BigEndianByteIndexerTests
{
   ...
   public void Implicit_Conversion_ToString_Returns_Expected_String(object item, string expectedString, bool arrayAsSpan)
   {
   ...
   public void Conversion_From_LittleEndianByteIndexer_Gives_Expected_Result(ulong data)
   {
      LittleEndianByteIndexer leData = data;
      var sut = (BigEndianByteIndexer) leData;
   ...
   [Theory]
   [InlineData(0x0A0B0C0D, new byte[] { 0x0A, 0x0B, 0x0C, 0x0D })]
   [InlineData(0xA0B0C0D0, new byte[] { 0xA0, 0xB0, 0xC0, 0xD0 })]
   ...
   {
      BigEndianByteIndexer beData = data;
      var sut = beData;
      Assert.Equal(data, (ulong) sut);
   }
   ...
   public void Indexer_Get_Throws_ArgumentOutOfRangeException_When_Given_Invalid_Index(int index)
   {
      Assert.Throws<ArgumentOutOfRangeException>(() =>
                                                 {
                                                    BigEndianByteIndexer sut = 0xFF_FE_FD_FC_FA_F9_F8_F7;
                                                    _ = sut[index];
                                                 }
                                                );
   }
   ...
   public void Indexer_Set_UInt64_Returns_Expected_Value(ulong rawValue, byte data, int offset, ulong expected)
   {
   ...
   public void Indexer_Set_Int64_Returns_Expected_Value(long rawValue, byte data, int offset, long expected)
   {
      BigEndianByteIndexer value = rawValue;
      value[offset] = data;
   ...
   public void Indexer_Set_UInt32_Returns_Expected_Value(uint rawValue, byte data, int offset, uint expected)
   {
      BigEndianByteIndexer value = rawValue;
      value[offset] = data;
   ...
   public void Indexer_Set_Int32_Returns_Expected_Value(int rawValue, byte data, int offset, int expected)
   {
      BigEndianByteIndexer value = rawValue;
      value[offset] = data;
   ...
   public void Indexer_Set_UInt16_Returns_Expected_Value(ushort rawValue, byte data, int offset, ushort expected)
   {
      BigEndianByteIndexer value = rawValue;
      value[offset] = data;
   ...
   public void Indexer_Set_Int16_Returns_Expected_Value(short rawValue, byte data, int offset, short expected)
   {
      BigEndianByteIndexer value = rawValue;
      value[offset] = data;
   ...
   public void Slice_From_UInt64_Returns_Expected_Array(ulong baseData, int offset, int size)
   {
   ...
   [InlineData(0xFF_FE_FD_FC_FB_FA_F9_F8, 5, 2)]
   [InlineData(0xFF_FE_FD_FC_FB_FA_F9_F8, 6, 2)]
   public void Slice_From_Int64_Returns_Expected_Array(ulong baseData, int offset, int size)
   {
   ...
   public void Slice_From_UInt32_Returns_Expected_Array(uint baseData, int offset, int size)
   {
      BigEndianByteIndexer data = baseData;
      var expected = new List<byte>();
   ...
   [InlineData(0xFB_FA_F9_F8, 2, 2)]
   [InlineData(0xFB_FA_F9_F8, 0, 3)]
   public void Slice_From_Int32_Returns_Expected_Array(uint baseData, int offset, int size)
   {
   ...
   public void Slice_From_UInt16_Returns_Expected_Array(ushort baseData, int offset, int size)
   {
      BigEndianByteIndexer data = baseData;
      var expected = new List<byte>();
   ...
   [InlineData(0xF9_F8, 0, 2)]
   [InlineData(0xFB_FA, 1, 1)]
   public void Slice_From_Int16_Returns_Expected_Array(ushort baseData, int offset, int size)
   {
