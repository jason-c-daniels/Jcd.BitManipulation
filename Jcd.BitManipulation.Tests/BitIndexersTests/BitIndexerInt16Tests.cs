...
{
   [Fact]
   public void Constant_Bit_Size_Is_16_Bits() { Assert.Equal(16, BitIndexerInt16.BitSize); }

   [Fact]
   public void Length_Is_Bit_Size() { Assert.Equal(BitIndexerInt16.BitSize, new BitIndexerInt16().Length); }
