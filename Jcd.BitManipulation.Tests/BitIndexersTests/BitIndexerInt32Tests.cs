...
{
   [Fact]
   public void Constant_Bit_Size_Is_32_Bits() { Assert.Equal(32, BitIndexerInt32.BitSize); }

   [Fact]
   public void Length_Is_Bit_Size() { Assert.Equal(BitIndexerInt32.BitSize, new BitIndexerInt32().Length); }
