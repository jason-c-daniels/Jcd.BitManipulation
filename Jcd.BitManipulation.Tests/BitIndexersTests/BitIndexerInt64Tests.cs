...
{
   [Fact]
   public void Constant_Bit_Size_Is_64_Bits() { Assert.Equal(64, BitIndexerInt64.BitSize); }

   [Fact]
   public void Length_Is_Bit_Size() { Assert.Equal(BitIndexerInt64.BitSize, new BitIndexerInt64().Length); }
