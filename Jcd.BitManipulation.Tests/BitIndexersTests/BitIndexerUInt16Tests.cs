...
{
   [Fact]
   public void Constant_Bit_Size_Is_16_Bits() { Assert.Equal(16, BitIndexerUInt16.BitSize); }

   [Fact]
   public void Length_Is_Bit_Size() { Assert.Equal(BitIndexerUInt16.BitSize, new BitIndexerUInt16().Length); }
