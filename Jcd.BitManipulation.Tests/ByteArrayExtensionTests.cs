...
public class ByteArrayExtensionTests
{
   ...
   public void ToByteArray_On_UInt32_Returns_Expected_Value(
      uint   data
    , Endian endian
    , byte   e0
    , byte   e1
   ...
   public void ToByteArray_On_Int32_Returns_Expected_Value(
      int    data
    , Endian endian
    , byte   e0
    , byte   e1
   ...
   public void ToByteArray_On_UInt64_Returns_Expected_Value(
      ulong  data
    , Endian endian
    , byte   e0
    , byte   e1
   ...
   public void ToByteArray_On_Int64_Returns_Expected_Value(
      long   data
    , Endian endian
    , byte   e0
    , byte   e1
   ...
   public void ToUInt32_On_ReadOnlySpan(
      byte   d0
    , byte   d1
    , byte   d2
    , byte   d3
   ...
   public void ToInt32_On_ReadOnlySpan(
      byte   d0
    , byte   d1
    , byte   d2
    , byte   d3
   ...
   public void ToUInt64_On_ReadOnlySpan(
      byte   d0
    , byte   d1
    , byte   d2
    , byte   d3
   ...
   public void ToInt64_On_ReadOnlySpan(
      byte   d0
    , byte   d1
    , byte   d2
    , byte   d3
