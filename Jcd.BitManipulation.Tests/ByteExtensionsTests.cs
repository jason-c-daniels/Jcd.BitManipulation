...
public class ByteExtensionsTests
{
   ...
   public void AreAnyBitsSet_Returns_The_Expected_Result(byte data, ulong mask, bool expected)
   {
   ...
   public void AreAllBits_Returns_The_Expected_Result(byte data, ulong mask, bool expected)
   {
   ...
   public void AreNoBitsSet_Returns_The_Expected_Result(byte data, ulong mask, bool expected)
   {
   ...
   public void ClearBits_When_Given_A_Mask_Directly_Clears_Only_The_Specified_Bits(byte initialValue, uint maskValue, byte expected)
   {
   ...
   public void StoreBits_Stores_The_Correct_Bits(byte initial, byte val, int offset, int size, uint expected)
   {
   ...
   public void ToByteArray_Returns_Expected_Value(byte data, byte e0)
   {
      var expected = new[] { e0 };
