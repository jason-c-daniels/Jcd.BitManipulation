...
public class Int16ExtensionsTests
{
   ...
   public void ClearBits_Clears_The_Correct_Bits(short initial, int offset, int size, short expected)
   {
   ...
   public void ClearBits_When_Given_A_Mask_Directly_Clears_Only_The_Specified_Bits(ushort initialValue, uint maskValue, ushort expected)
   {
   ...
   public void SetBits_Sets_The_Correct_Bits(short initial, int offset, int size, ushort expected)
   {
      var value = initial; // coerce to proper type
   ...
   public void SetBit_Sets_Correct_Bit(short initial, int bitToSet, ushort expected)
   {
      var value = initial;
   ...
   public void SetBits_When_Given_A_Mask_Directly_Sets_Only_The_Specified_Bits(ushort initialValue, ulong maskValue, ushort expected)
   {
      var value = (short) initialValue;
      var mask = new BitMask((short) maskValue);
   ...
   public void ReadBit_Reads_The_Correct_Value(ushort data, int offset, bool expected)
   {
      var bits = (short) data;
   ...
   public void StoreBits_Stores_The_Correct_Bits(ushort initial, uint val, int offset, int size, ushort expected)
   {
   ...
   public void StoreByte_Returns_Expected_Value(short value, byte data, int offset, short expected, Endian endian)
   {
   ...
   public void StoreBytes_From_Byte_Array_Returns_Expected_Value(short data, int offset, int size, byte[] bytes, Endian endian)
   {
      var expected = data;
   ...
   [Theory]
   [MemberData(nameof(Int16StoreBytesWithEndian))]
   public void StoreBytes_From_ReadOnlySpan_Returns_Expected_Value(short data, int offset, int size, byte[] bytes, Endian endian)
   {
      var expected = data;
   ...
   [InlineData(0b111111111111, 8, 2, 0b110011111111)]
   public void ToggleBits_Toggles_The_Correct_Bits(short initial, int offset, int size, uint expected)
   {
      var value = initial; // coerce to proper type
   ...
   [InlineData(0b1111111111111111, 0b0100000000000110, 0b1011111111111001)]
   [InlineData(0b1111111110111111, 0b0100000000000100, 0b1011111110111011)]
   public void ToggleBits_When_Given_A_Mask_Directly_Toggles_Only_The_Specified_Bits(ushort initialValue, uint maskValue, ushort expected)
   {
      // forcibly cast so that guarantee the proper data size, and so that the xUnit data binder can bind the values to the params.
      var value = (short) initialValue;
      var mask = new BitMask((short) maskValue);
   ...
   public void ToByteArray_Returns_Expected_Value(short data, Endian endian, byte e0, byte e1)
   {
