...
public class ReadBitsExtensionsTests
{
   ...
   [InlineData(0x3000000F, 28, 4, 0x03)]
   [InlineData(0xF000000F, 30, 2, 0x03)]
   public void ReadBits_On_Single_Reads_The_Correct_Bits(uint initial, int offset, int size, uint expected)
   {
      var value = initial.BitwiseToSingle().ReadBits(offset, size);
      Assert.Equal(expected, value);
   }
   ...
   [InlineData(0x300000000000000F, 60, 4, 0x03)]
   [InlineData(0xF00000000000000F, 62, 2, 0x03)]
   public void ReadBits_On_Double_Reads_The_Correct_Bits(ulong initial, int offset, int size, ulong expected)
   {
      var value = initial.BitwiseToDouble().ReadBits(offset, size);
      Assert.Equal(expected, value);
   }   
   #endregion
   ...
   public void ReadBit_For_SByte_Reads_The_Correct_Value(uint bits, int offset, bool expected) { Assert.Equal(expected, ((sbyte) bits).ReadBit((byte) offset)); }

   [Theory]
   [InlineData(0b11100111, 0, true)]
   [InlineData(0b11100111, 3, false)]
   [InlineData(0b11100111, 7, true)]
   public void ReadBit_For_Byte_Reads_The_Correct_Value(uint bits, int offset, bool expected) { Assert.Equal(expected, ((byte) bits).ReadBit((byte) offset)); }
   ...
   public void ReadBit_For_Int16_Reads_The_Correct_Value(uint bits, int offset, bool expected) { Assert.Equal(expected, ((short) bits).ReadBit((byte) offset)); }
   ...
   [InlineData(0b1110011100000000, 11, false)]
   [InlineData(0b1110011100000000, 15, true)]
   public void ReadBit_For_UInt16_Reads_The_Correct_Value(uint bits, int offset, bool expected) { Assert.Equal(expected, ((ushort) bits).ReadBit((byte) offset)); }
   ...
   public void ReadBit_For_Int32_Reads_The_Correct_Value(uint bits, int offset, bool expected) { Assert.Equal(expected, ((int) bits).ReadBit((byte) offset)); }
   ...
   [InlineData((uint) 0b11100111 << 24, 27, false)]
   [InlineData((uint) 0b11100111 << 24, 31, true)]
   public void ReadBit_For_UInt32_Reads_The_Correct_Value(uint bits, int offset, bool expected) { Assert.Equal(expected, bits.ReadBit((byte) offset)); }
   ...
   public void ReadBit_For_Int64_Reads_The_Correct_Value(ulong bits, int offset, bool expected) { Assert.Equal(expected, ((long) bits).ReadBit((byte) offset)); }
   ...
   [InlineData((ulong) 0b11100111 << 56, 59, false)]
   [InlineData((ulong) 0b11100111 << 56, 63, true)]
   public void ReadBit_For_UInt64_Reads_The_Correct_Value(ulong bits, int offset, bool expected) { Assert.Equal(expected, bits.ReadBit((byte) offset)); }
   ...
   [InlineData((uint) 0b11100111 << 24, 27, false)]
   [InlineData((uint) 0b11100111 << 24, 31, true)]
   public void ReadBit_For_Single_Reads_The_Correct_Value(uint bits, int offset, bool expected)
   {
   ...
   [InlineData((ulong) 0b11100111 << 56, 59, false)]
   [InlineData((ulong) 0b11100111 << 56, 63, true)]
   public void ReadBit_For_Double_Reads_The_Correct_Value(ulong bits, int offset, bool expected)
   {
      Assert.Equal(expected, bits.BitwiseToDouble().ReadBit((byte) offset));
   }
