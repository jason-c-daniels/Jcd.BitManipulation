...
public class SByteExtensionsTests
{
   ...
   public void AreAnyBitsSet_Returns_The_Expected_Result(sbyte data, ulong mask, bool expected)
   {
   ...
   public void AreAllBits_Returns_The_Expected_Result(sbyte data, ulong mask, bool expected)
   {
   ...
   public void AreNoBitsSet_Returns_The_Expected_Result(sbyte data, ulong mask, bool expected)
   {
   ...
   public void ClearBits_Clears_The_Correct_Bits(byte initial, int offset, int size, byte expected)
   {
   ...
   public void ClearBit_Clears_Correct_Bit(byte initial, int bitToClear, byte expected)
   {
   ...
   public void ClearBits_When_Given_A_Mask_Directly_Clears_Only_The_Specified_Bits(byte initialValue, sbyte maskValue, byte expected)
   {
   ...
   public void SetBits_Sets_The_Correct_Bits(byte initial, int offset, int size, byte expected)
   {
      var value = (sbyte) initial; // coerce to proper type
   ...
   public void SetBit_Sets_Correct_Bit(byte initial, int bitToSet, byte expected)
   {
      var value = (sbyte) initial;
   ...
   public void SetBits_When_Given_A_Mask_Directly_Sets_Only_The_Specified_Bits(byte initialValue, byte maskValue, byte expected)
   {
      // forcibly cast so that guarantee the proper data size, and so that the xUnit data binder can bind the values to the params.
      var value = (sbyte) initialValue;
   ...
   public void ReadBits_Reads_The_Correct_Bits(byte initial, int offset, int size, byte expected)
   {
   ...
   public void ReadBit_Reads_The_Correct_Value(byte bits, int offset, bool expected)
   {
   ...
   public void StoreBits_Stores_The_Correct_Bits(byte initial, uint val, int offset, int size, byte expected)
   {
   ...
   public void StoreBit_Sets_The_Specified_Bit_To_The_Target_Value(byte destination, int offset, bool bit, byte expected)
   {
   ...
   public void ToggleBits_Toggles_The_Correct_Bits(byte initial, int offset, int size, byte expected)
   {
      var value = (sbyte) initial; // coerce to proper type
   ...
   [InlineData(0xFF, 4, 0xEF)]
   [InlineData(0xFF, 7, 0x7F)]
   public void ToggleBit_Toggles_Correct_Bit(byte initial, int bitToToggle, byte expected)
   {
      var value = (sbyte) initial;
   ...
   [InlineData(0b11111111, 0b0000110, 0b11111001)]
   [InlineData(0b10111111, 0b0000100, 0b10111011)]
   public void ToggleBits_When_Given_A_Mask_Directly_Toggles_Only_The_Specified_Bits(byte initialValue, byte maskValue, byte expected)
   {
      // forcibly cast so that guarantee the proper data size, and so that the xUnit data binder can bind the values to the params.
      var value = (sbyte) initialValue;
      var mask = new BitMask((sbyte) maskValue);
   ...
   public void ToByteArray_Returns_Expected_Value(sbyte data, byte e0)
   {
      var expected = new[] { e0 };
