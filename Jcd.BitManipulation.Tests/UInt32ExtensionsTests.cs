...
public class UInt32ExtensionsTests
{
   ...
   public void AreAnyBitsSet_Returns_The_Expected_Result(uint data, uint mask, bool expected)
   {
   ...
   public void AreAllBits_Returns_The_Expected_Result(uint data, uint mask, bool expected)
   {
   ...
   public void AreNoBitsSet_Returns_The_Expected_Result(uint data, uint mask, bool expected)
   {
   ...
   public void SetBit_Sets_Correct_Bit(uint initial, int bitToSet, uint expected)
   {
      var value = initial;
   ...
   public void ReadBits_Reads_The_Correct_Bits(uint bits, int offset, int size, uint expected)
   {
