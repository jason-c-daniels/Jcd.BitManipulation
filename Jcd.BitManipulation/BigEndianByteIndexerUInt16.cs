...
/// <summary>
/// Provides byte level indexing operations (set, get) on a <see cref="ushort" />. Zero is the most significant byte.
/// </summary>
...
public struct BigEndianByteIndexerUInt16 : IByteIndexer
{
   ...
   /// <summary>
   /// Constructs a <see cref="BigEndianByteIndexerUInt16" /> from a <see cref="ushort" />.
   /// </summary>
   ...
   [MethodImpl(MethodImplOptions.AggressiveInlining)]
   public static implicit operator ushort(BigEndianByteIndexerUInt16 indexer)
   {
      return indexer.Data;
   }
