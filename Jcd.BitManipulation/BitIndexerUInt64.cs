...
{
    public struct BitIndexerUInt64 : IEnumerable<bool>, IBitIndexer
    {
        ...
        public static implicit operator ulong(BitIndexerUInt64 indexer) => indexer.bits;
