...
/// <summary>
/// Provides enumeration and indexed access to the bits on a stored <see cref="float"/>. 
/// </summary>
public struct BitIndexerSingle : IBitIndexer
{
   /// <summary>
   ...
   /// <summary>
   /// Automatically Convert from a <see cref="float"/> to a <see cref="BitIndexerSingle"/>
   /// </summary>
   /// <param name="bits">the initial value for the indexer's backing store</param>
   /// <returns>A new <see cref="BitIndexerSingle"/></returns>
   [MethodImpl(MethodImplOptions.AggressiveInlining)]
   public static implicit operator BitIndexerSingle(float bits) { return new BitIndexerSingle { Bits = bits }; }

   /// <summary>
   /// Automatically convert from a <see cref="BitIndexerSingle"/> to a <see cref="float"/>
   /// </summary>
   /// <param name="indexer">the indexer to convert from</param>
   /// <returns>the <see cref="float"/></returns>
   [MethodImpl(MethodImplOptions.AggressiveInlining)]
   public static implicit operator float(BitIndexerSingle indexer) { return indexer.Bits; }
