...
public struct BitIndexerSingle : IBitIndexer
{
   ...
   [MethodImpl(MethodImplOptions.AggressiveInlining)]
   public static implicit operator BitIndexerSingle(float bits)
   {
      return new BitIndexerSingle { Bits = bits };
   }
   ...
   [MethodImpl(MethodImplOptions.AggressiveInlining)]
   public static implicit operator float(BitIndexerSingle indexer)
   {
      return indexer.Bits;
   }
