...
/// </summary>
public struct ByteIndexerByte : IByteIndexer
{
    /// <summary>
    ...
    public ByteIndexerByte(byte data = 0)
    {
        Data = data;
    }
    ...
    public static implicit operator byte(ByteIndexerByte buffer)
    {
        return buffer.Data;
    }
    ...
    public static implicit operator ByteIndexerByte(byte data)
    {
        return new ByteIndexerByte(data);
    }
