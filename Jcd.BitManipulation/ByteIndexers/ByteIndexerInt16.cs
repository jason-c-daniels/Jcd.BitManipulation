...
/// </summary>
public struct ByteIndexerInt16 : IByteIndexer
{
    /// <summary>
    ...
    public static implicit operator short(ByteIndexerInt16 buffer)
    {
        return buffer.Data;
    }
    ...
    public static implicit operator ByteIndexerInt16(short data)
    {
        return new ByteIndexerInt16(data);
    }
