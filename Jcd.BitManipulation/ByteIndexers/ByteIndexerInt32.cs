...
/// </summary>
public struct ByteIndexerInt32 : IByteIndexer
{
    /// <summary>
    ...
    public static implicit operator int(ByteIndexerInt32 buffer)
    {
        return buffer.Data;
    }
    ...
    public static implicit operator ByteIndexerInt32(int data)
    {
        return new ByteIndexerInt32(data);
    }
