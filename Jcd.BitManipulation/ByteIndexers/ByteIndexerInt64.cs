...
/// </summary>
public struct ByteIndexerInt64 : IByteIndexer
{
    /// <summary>
    ...
    public ByteIndexerInt64(long data = 0)
    {
        Data = data;
    }
    ...
    public static implicit operator long(ByteIndexerInt64 buffer)
    {
        return buffer.Data;
    }
    ...
    public static implicit operator ByteIndexerInt64(long data)
    {
        return new ByteIndexerInt64(data);
    }
