...
/// </summary>
public struct ByteIndexerUInt32 : IByteIndexer
{
    /// <summary>
    ...
    public ByteIndexerUInt32(uint data = 0)
    {
        Data = data;
    }
    ...
    public static implicit operator uint(ByteIndexerUInt32 buffer)
    {
        return buffer.Data;
    }
    ...
    public static implicit operator ByteIndexerUInt32(uint data)
    {
        return new ByteIndexerUInt32(data);
    }
