...
/// </summary>
public struct ByteIndexerUInt64 : IByteIndexer
{
    /// <summary>
    ...
    public ByteIndexerUInt64(ulong data = 0)
    {
        Data = data;
    }
    ...
    public static implicit operator ulong(ByteIndexerUInt64 indexer)
    {
        return indexer.Data;
    }
    ...
    public static implicit operator ByteIndexerUInt64(ulong data)
    {
        return new ByteIndexerUInt64(data);
    }
