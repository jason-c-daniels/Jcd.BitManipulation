...
/// <summary>
/// Provides byte level indexing operations (set, get) on a <see cref="UInt32"/>. Zero is the least significant byte.
/// </summary>
public struct LittleEndianByteIndexerUInt32 : IByteIndexer
{
   ...
   public LittleEndianByteIndexerUInt32(uint data = 0) { Data = data; }
   ...
   [MethodImpl(MethodImplOptions.AggressiveInlining)]
   public static implicit operator uint(LittleEndianByteIndexerUInt32 buffer) { return buffer.Data; }
   ...
   [MethodImpl(MethodImplOptions.AggressiveInlining)]
   public static implicit operator LittleEndianByteIndexerUInt32(uint data) { return new LittleEndianByteIndexerUInt32(data); }
