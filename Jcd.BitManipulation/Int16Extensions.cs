...
/// </summary>
/// <include file='XmlDocs/examples.xml' path='/doc/examples/item[@name="Int16Extensions"]/example' />
public static class Int16Extensions
{
   ...
   public static bool AreAllBitsSet(this short number, BitMask bitmask)
   {
   ...
   /// </remarks>
   [MethodImpl(MethodImplOptions.AggressiveInlining)]
   public static bool AreAnyBitsSet(this short number, BitMask bitmask)
   {
   ...
   /// </remarks>
   [MethodImpl(MethodImplOptions.AggressiveInlining)]
   public static bool AreNoBitsSet(this short number, BitMask bitmask)
   {
      return (number & bitmask) == 0;
   }

   /// <summary>
   /// Converts a <see cref="short" /> into an array of <see cre="bool" /> values with the lease significant bit at index 0.
   /// </summary>
   /// <param name="number">The <see cref="short" /> to convert.</param>
   ...
   /// <summary>
   /// Converts a <see cref="short" /> into an array of bytes in the specified <see cref="Endian" />.
   /// </summary>
   ...
   [MethodImpl(MethodImplOptions.AggressiveInlining)]
   public static byte[] ToByteArray(this short number, Endian endian = Endian.Little)
   {
      return endian == Endian.Big
                ? ((BigEndianByteIndexer) number).Slice(0, sizeof(short))
                : ((LittleEndianByteIndexer) number).Slice(0, sizeof(short));
   }
   ...
   [MethodImpl(MethodImplOptions.AggressiveInlining)]
   public static short ClearBits(this short number, int offset = 0, int size = sizeof(short) * BitSizeConstants.BitsPerByte)
   {
   ...
   /// <returns>The modified value.</returns>
   [MethodImpl(MethodImplOptions.AggressiveInlining)]
   public static short ClearBits(this short number, BitMask mask)
   {
      return (short) ((ushort) number).ClearBits(mask);
   }
   ...
   [MethodImpl(MethodImplOptions.AggressiveInlining)]
   public static short ReadBits(this short number, BitMask mask)
   {
   ...
   [MethodImpl(MethodImplOptions.AggressiveInlining)]
   public static short ReadBits(this short number, int shift, BitMask mask)
   {
      return (short) ((ushort) number).ReadBits(shift, mask);
   }
   ...
   {
      return ((ushort) number).ReadBit(offset);
   }
   ...
   [MethodImpl(MethodImplOptions.AggressiveInlining)]
   public static byte[] ReadBytes(this short number, int offset, int size, Endian endian = Endian.Little)
   {
      return endian == Endian.Big
   ...
   [MethodImpl(MethodImplOptions.AggressiveInlining)]
   public static byte ReadByte(this short number, int offset, Endian endian = Endian.Little)
   {
   ...
   /// <returns>The modified value.</returns>
   [MethodImpl(MethodImplOptions.AggressiveInlining)]
   public static short SetBits(this short number, int offset = 0, int size = sizeof(short) * BitSizeConstants.BitsPerByte)
   {
   ...
   /// <returns>The modified value.</returns>
   [MethodImpl(MethodImplOptions.AggressiveInlining)]
   public static short SetBits(this short number, BitMask mask)
   {
      return (short) ((ushort) number).SetBits(mask);
   }
   ...
   /// <returns>The modified value.</returns>
   [MethodImpl(MethodImplOptions.AggressiveInlining)]
   public static short StoreBits(this short number, short source, int offset, BitMask mask)
   {
      return (short) ((ushort) number).StoreBits((ushort) source, offset, mask);
   }
   ...
   /// <returns>The modified value.</returns>
   [MethodImpl(MethodImplOptions.AggressiveInlining)]
   public static short StoreBytes(this short number, byte[] bytes, int offset, int size = -1, Endian endian = Endian.Little)
   {
      return endian == Endian.Big
   ...
   /// <returns>The modified value.</returns>
   [MethodImpl(MethodImplOptions.AggressiveInlining)]
   public static short StoreBytes(this short number, ReadOnlySpan<byte> bytes, int offset, int size = -1, Endian endian = Endian.Little)
   {
      return endian == Endian.Big
                ? ((BigEndianByteIndexer) number).StoreBytes(bytes, offset, size)
                : ((LittleEndianByteIndexer) number).StoreBytes(bytes, offset, size);
   ...
   /// <returns>The modified value.</returns>
   [MethodImpl(MethodImplOptions.AggressiveInlining)]
   public static short StoreByte(this short number, byte @byte, int offset, Endian endian = Endian.Little)
   {
      if (endian == Endian.Little)
      {
   ...
   /// <returns>The modified value.</returns>
   [MethodImpl(MethodImplOptions.AggressiveInlining)]
   public static short ToggleBits(this short number, int offset = 0, int size = sizeof(short) * BitSizeConstants.BitsPerByte)
   {
   ...
   /// <returns>The modified value.</returns>
   [MethodImpl(MethodImplOptions.AggressiveInlining)]
   public static short ToggleBits(this short number, BitMask mask)
   {
      return (short) ((ushort) number).ToggleBits(mask);
   }
}