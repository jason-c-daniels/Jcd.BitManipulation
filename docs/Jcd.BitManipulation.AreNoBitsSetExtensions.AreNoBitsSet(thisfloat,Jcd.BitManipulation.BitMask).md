...
<a name='Jcd.BitManipulation.AreNoBitsSetExtensions.AreNoBitsSet(thisfloat,Jcd.BitManipulation.BitMask).data'></a>

`data` [System.Single](https://docs.microsoft.com/en-us/dotnet/api/System.Single 'System.Single')

The data to inspect.

<a name='Jcd.BitManipulation.AreNoBitsSetExtensions.AreNoBitsSet(thisfloat,Jcd.BitManipulation.BitMask).bitmask'></a>
