...
Constructs a [BigEndianByteIndexer](Jcd.BitManipulation.BigEndianByteIndexer.md 'Jcd.BitManipulation.BigEndianByteIndexer') from an [System.Single](https://docs.microsoft.com/en-us/dotnet/api/System.Single 'System.Single').
...
<a name='Jcd.BitManipulation.BigEndianByteIndexer.BigEndianByteIndexer(float).data'></a>
