...
```csharp
public static short ToInt16(this Jcd.BitManipulation.BitIndexers.IBitIndexer indexer);
```
#### Parameters

<a name='Jcd.BitManipulation.BitIndexers.BitIndexerExtensions.ToInt16(thisJcd.BitManipulation.BitIndexers.IBitIndexer).indexer'></a>
