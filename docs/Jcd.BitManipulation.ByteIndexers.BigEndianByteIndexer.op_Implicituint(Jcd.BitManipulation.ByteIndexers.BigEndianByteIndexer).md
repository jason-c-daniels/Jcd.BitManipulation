...
```csharp
public static uint implicit operator uint(Jcd.BitManipulation.ByteIndexers.BigEndianByteIndexer indexer);
```

#### Parameters

<a name='Jcd.BitManipulation.ByteIndexers.BigEndianByteIndexer.op_Implicituint(Jcd.BitManipulation.ByteIndexers.BigEndianByteIndexer).indexer'></a>
