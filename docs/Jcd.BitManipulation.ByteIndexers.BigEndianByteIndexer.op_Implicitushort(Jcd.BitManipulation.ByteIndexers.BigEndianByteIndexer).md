...
```csharp
public static ushort implicit operator ushort(Jcd.BitManipulation.ByteIndexers.BigEndianByteIndexer indexer);
```
#### Parameters

<a name='Jcd.BitManipulation.ByteIndexers.BigEndianByteIndexer.op_Implicitushort(Jcd.BitManipulation.ByteIndexers.BigEndianByteIndexer).indexer'></a>
