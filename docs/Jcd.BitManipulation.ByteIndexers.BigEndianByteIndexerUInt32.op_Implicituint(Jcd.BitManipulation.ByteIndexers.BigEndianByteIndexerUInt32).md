...
```csharp
public static uint implicit operator uint(Jcd.BitManipulation.ByteIndexers.BigEndianByteIndexerUInt32 indexer);
```

#### Parameters

<a name='Jcd.BitManipulation.ByteIndexers.BigEndianByteIndexerUInt32.op_Implicituint(Jcd.BitManipulation.ByteIndexers.BigEndianByteIndexerUInt32).indexer'></a>
