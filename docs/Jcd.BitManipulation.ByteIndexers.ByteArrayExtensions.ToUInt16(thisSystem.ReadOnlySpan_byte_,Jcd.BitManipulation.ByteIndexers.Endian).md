...
```csharp
public static ushort ToUInt16(this System.ReadOnlySpan<byte> data, Jcd.BitManipulation.ByteIndexers.Endian endian=Jcd.BitManipulation.ByteIndexers.Endian.Little);
```
#### Parameters

<a name='Jcd.BitManipulation.ByteIndexers.ByteArrayExtensions.ToUInt16(thisSystem.ReadOnlySpan_byte_,Jcd.BitManipulation.ByteIndexers.Endian).data'></a>
...
<a name='Jcd.BitManipulation.ByteIndexers.ByteArrayExtensions.ToUInt16(thisSystem.ReadOnlySpan_byte_,Jcd.BitManipulation.ByteIndexers.Endian).endian'></a>
