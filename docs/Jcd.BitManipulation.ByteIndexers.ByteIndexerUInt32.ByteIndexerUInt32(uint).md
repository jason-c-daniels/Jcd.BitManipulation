...
## ByteIndexerUInt32(uint) Constructor

Constructs a byte indexer from the underlying data type.

```csharp
public ByteIndexerUInt32(uint data=0u);
```
#### Parameters

<a name='Jcd.BitManipulation.ByteIndexers.ByteIndexerUInt32.ByteIndexerUInt32(uint).data'></a>
