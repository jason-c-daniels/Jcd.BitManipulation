...
```csharp
public static byte implicit operator byte(Jcd.BitManipulation.ByteIndexers.LittleEndianByteIndexer indexer);
```
#### Parameters

<a name='Jcd.BitManipulation.ByteIndexers.LittleEndianByteIndexer.op_Implicitbyte(Jcd.BitManipulation.ByteIndexers.LittleEndianByteIndexer).indexer'></a>
