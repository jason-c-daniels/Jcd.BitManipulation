...
## LittleEndianByteIndexer.implicit operator double(LittleEndianByteIndexer) Operator

Implicitly converts the byte indexer to its underlying data type.

```csharp
public static double implicit operator double(Jcd.BitManipulation.ByteIndexers.LittleEndianByteIndexer indexer);
```

#### Parameters

<a name='Jcd.BitManipulation.ByteIndexers.LittleEndianByteIndexer.op_Implicitdouble(Jcd.BitManipulation.ByteIndexers.LittleEndianByteIndexer).indexer'></a>
