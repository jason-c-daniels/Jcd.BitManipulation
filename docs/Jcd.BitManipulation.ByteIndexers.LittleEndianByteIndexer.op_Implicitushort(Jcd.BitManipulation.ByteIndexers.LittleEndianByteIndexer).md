...
## LittleEndianByteIndexer.implicit operator ushort(LittleEndianByteIndexer) Operator
...
```csharp
public static ushort implicit operator ushort(Jcd.BitManipulation.ByteIndexers.LittleEndianByteIndexer indexer);
```
#### Parameters

<a name='Jcd.BitManipulation.ByteIndexers.LittleEndianByteIndexer.op_Implicitushort(Jcd.BitManipulation.ByteIndexers.LittleEndianByteIndexer).indexer'></a>
