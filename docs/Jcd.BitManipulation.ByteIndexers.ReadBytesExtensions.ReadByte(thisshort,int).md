...
<a name='Jcd.BitManipulation.ByteIndexers.ReadBytesExtensions.ReadByte(thisshort,int).value'></a>

`value` [System.Int16](https://docs.microsoft.com/en-us/dotnet/api/System.Int16 'System.Int16')

The value to be read.

<a name='Jcd.BitManipulation.ByteIndexers.ReadBytesExtensions.ReadByte(thisshort,int).offset'></a>
