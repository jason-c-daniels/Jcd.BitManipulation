...
## ReadBytesExtensions.ReadByte(this uint, int) Method
...
<a name='Jcd.BitManipulation.ReadBytesExtensions.ReadByte(thisuint,int).value'></a>

`value` [System.UInt32](https://docs.microsoft.com/en-us/dotnet/api/System.UInt32 'System.UInt32')

The value to be read.

<a name='Jcd.BitManipulation.ReadBytesExtensions.ReadByte(thisuint,int).offset'></a>
