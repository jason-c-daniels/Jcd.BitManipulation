...
## ReadBytesExtensions.ReadByte(this ushort, int) Method
...
<a name='Jcd.BitManipulation.ReadBytesExtensions.ReadByte(thisushort,int).value'></a>

`value` [System.UInt16](https://docs.microsoft.com/en-us/dotnet/api/System.UInt16 'System.UInt16')

The value to be read.

<a name='Jcd.BitManipulation.ReadBytesExtensions.ReadByte(thisushort,int).offset'></a>
