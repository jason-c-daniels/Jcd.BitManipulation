...
## SetBitsExtensions.SetBit(this double, int) Method
...
<a name='Jcd.BitManipulation.SetBitsExtensions.SetBit(thisdouble,int).value'></a>

`value` [System.Double](https://docs.microsoft.com/en-us/dotnet/api/System.Double 'System.Double')

The value to be modified.

<a name='Jcd.BitManipulation.SetBitsExtensions.SetBit(thisdouble,int).offset'></a>
