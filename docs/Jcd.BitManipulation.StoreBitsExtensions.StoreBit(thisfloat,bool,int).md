...
## StoreBitsExtensions.StoreBit(this float, bool, int) Method
...
<a name='Jcd.BitManipulation.StoreBitsExtensions.StoreBit(thisfloat,bool,int).value'></a>

`value` [System.Single](https://docs.microsoft.com/en-us/dotnet/api/System.Single 'System.Single')

The value to be modified.

<a name='Jcd.BitManipulation.StoreBitsExtensions.StoreBit(thisfloat,bool,int).bit'></a>

`bit` [System.Boolean](https://docs.microsoft.com/en-us/dotnet/api/System.Boolean 'System.Boolean')

The bit value to set

<a name='Jcd.BitManipulation.StoreBitsExtensions.StoreBit(thisfloat,bool,int).offset'></a>
