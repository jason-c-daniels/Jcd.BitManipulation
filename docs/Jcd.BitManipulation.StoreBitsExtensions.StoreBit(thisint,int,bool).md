...
## StoreBitsExtensions.StoreBit(this int, int, bool) Method
...
<a name='Jcd.BitManipulation.StoreBitsExtensions.StoreBit(thisint,int,bool).self'></a>

`self` [System.Int32](https://docs.microsoft.com/en-us/dotnet/api/System.Int32 'System.Int32')

the bits to read from

<a name='Jcd.BitManipulation.StoreBitsExtensions.StoreBit(thisint,int,bool).offset'></a>

`offset` [System.Int32](https://docs.microsoft.com/en-us/dotnet/api/System.Int32 'System.Int32')

the offset to read

<a name='Jcd.BitManipulation.StoreBitsExtensions.StoreBit(thisint,int,bool).bit'></a>
