...
<a name='Jcd.BitManipulation.StoreBytesExtensions.StoreByte(thisdouble,byte,int).byte'></a>

`byte` [System.Byte](https://docs.microsoft.com/en-us/dotnet/api/System.Byte 'System.Byte')

The byte value to set

<a name='Jcd.BitManipulation.StoreBytesExtensions.StoreByte(thisdouble,byte,int).offset'></a>
