...
## ToggleBitsExtensions.ToggleBit(this ulong, int) Method
...
<a name='Jcd.BitManipulation.ToggleBitsExtensions.ToggleBit(thisulong,int).value'></a>

`value` [System.UInt64](https://docs.microsoft.com/en-us/dotnet/api/System.UInt64 'System.UInt64')

The value to be modified.

<a name='Jcd.BitManipulation.ToggleBitsExtensions.ToggleBit(thisulong,int).offset'></a>
