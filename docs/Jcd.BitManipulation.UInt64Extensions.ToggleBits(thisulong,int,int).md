...
```csharp
public static ulong ToggleBits(this ulong number, int offset=0, int size=64);
```

#### Parameters

<a name='Jcd.BitManipulation.UInt64Extensions.ToggleBits(thisulong,int,int).number'></a>
