...
## ToggleBitsExtensions.ToggleBit(uint, byte) Method
Toggles a bit, given a bit position.  
```csharp
public static void ToggleBit(this ref uint self, byte offset);
```
#### Parameters
<a name='Jcd_BitManipulation_ToggleBitsExtensions_ToggleBit(uint_byte)_self'></a>
`self` [System.UInt32](https://docs.microsoft.com/en-us/dotnet/api/System.UInt32 'System.UInt32')  
The value to be modified.
  
<a name='Jcd_BitManipulation_ToggleBitsExtensions_ToggleBit(uint_byte)_offset'></a>
