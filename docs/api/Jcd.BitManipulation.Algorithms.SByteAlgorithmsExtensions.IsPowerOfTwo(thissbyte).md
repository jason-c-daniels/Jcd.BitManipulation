...
## SByteAlgorithmsExtensions.IsPowerOfTwo(this sbyte) Method
...
<a name='Jcd.BitManipulation.Algorithms.SByteAlgorithmsExtensions.IsPowerOfTwo(thissbyte).number'></a>
