...
```csharp
public static sbyte ClearBits(this sbyte number, int offset=0, int size=8);
```
#### Parameters

<a name='Jcd.BitManipulation.SByteExtensions.ClearBits(thissbyte,int,int).number'></a>
