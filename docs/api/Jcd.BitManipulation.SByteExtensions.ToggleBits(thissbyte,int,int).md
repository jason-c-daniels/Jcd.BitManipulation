...
```csharp
public static sbyte ToggleBits(this sbyte number, int offset=0, int size=8);
```

#### Parameters

<a name='Jcd.BitManipulation.SByteExtensions.ToggleBits(thissbyte,int,int).number'></a>
